...
HD_PWD='D:/aulas/cr/projects/p02/p02.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e4_MaxValue.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e4_MaxValue.tcl
