...
HD_PWD='D:/aulas/cr/projects/p04/p04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log e1_Count_consec_ones.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source e1_Count_consec_ones.tcl -notrace
