...
HD_PWD='D:/aulas/cr/projects/p02/p02.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log e4_MaxValue.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source e4_MaxValue.tcl -notrace
