...
HD_PWD='D:/aulas/cr/projects/tarefas_minitest/tarefas_minitest.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tarefa3.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tarefa3.tcl -notrace
