...
HD_PWD='D:/aulas/cr/projects/projecto/SortWeights_4/SortWeights_4.runs/design_1_addr_mux_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_addr_mux_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_addr_mux_0_0.tcl
