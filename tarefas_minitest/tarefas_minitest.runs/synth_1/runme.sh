...
HD_PWD='D:/aulas/cr/projects/tarefas_minitest/tarefas_minitest.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tarefa3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tarefa3.tcl
