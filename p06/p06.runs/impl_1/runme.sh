...
HD_PWD='D:/aulas/cr/projects/p06/p06.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MemMaxMin.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MemMaxMin.tcl -notrace
