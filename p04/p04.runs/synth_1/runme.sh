...
HD_PWD='D:/aulas/cr/projects/p04/p04.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log e1_Count_consec_ones.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source e1_Count_consec_ones.tcl
