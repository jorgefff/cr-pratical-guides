...
HD_PWD='D:/aulas/cr/projects/projecto/SortWeights_5/SortWeights_5.runs/design_1_select_in_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_select_in_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_select_in_0_0.tcl
