...
set_property used_in_implementation false [get_files D:/aulas/cr/projects/p04/p04.srcs/constrs_1/imports/projects/Nexys4Alunos.xdc]

set_param ips.enableIPCacheLiteLoad 1
close [open __synthesis_is_running__ w]

synth_design -top e1_Count_consec_ones -part xc7a100tcsg324-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef e1_Count_consec_ones.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file e1_Count_consec_ones_utilization_synth.rpt -pb e1_Count_consec_ones_utilization_synth.pb"
