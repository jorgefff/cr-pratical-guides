...
HD_PWD='D:/aulas/cr/projects/p01/p01.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ex_1_9.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ex_1_9.tcl -notrace
